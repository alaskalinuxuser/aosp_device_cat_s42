...
TARGET_KERNEL_CONFIG := S42G_defconfig
TARGET_KERNEL_SOURCE := kernel/cat/S42G
...
BOARD_DTBOIMG_PARTITION_SIZE := 53248
...
# Verified Boot
BOARD_AVB_ENABLE := false # was true.
...
include vendor/cat/S42G/BoardConfigVendor.mk
